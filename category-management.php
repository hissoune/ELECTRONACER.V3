    ...
    if (isset($_POST['name_cat']) && isset($_FILES['file'])) {
        ...
        for ($i = 0; $i < $categoriesCount; $i++) {
            ...
            if (move_uploaded_file($tempPath, $targetPath)) {
                ...
                $stmt = $conn->prepare("INSERT INTO Categories (category_name, imag_category, is_disabled) VALUES (?, ?, FALSE)");
...
<div class="container mt-5">
    ...
    <div id="categories" class="w-100 mb-5">
        <table class="table table-bordered">
            ...
            <tbody>
                <?php
                $categoryQuery = "SELECT * FROM Categories where is_disabled= FALSE";
    ...
    <div id="categories" class="w-100">
        <table class="table table-bordered">
            ...
            <tbody>
                <?php
                $categoryQuery = "SELECT * FROM Categories where is_disabled = TRUE";
                $result = $conn->query($categoryQuery);
