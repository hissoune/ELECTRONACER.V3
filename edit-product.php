    ...
    <form method="post" action="" enctype="multipart/form-data" class="container">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Reference" name="reference" aria-label="Reference"
                aria-describedby="basic-addon1" value="<?php echo $product['reference']; ?>" required>
        </div>
        <!-- Product Label -->
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Label</span>
            <input type="text" class="form-control" placeholder="Product Name" name="product_name"
                aria-label="Product Name" aria-describedby="basic-addon1" value="<?php echo $product['label']; ?>"
                required>
        </div>
        <!-- Product description -->
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Description" name="description"
                aria-label="Description" aria-describedby="basic-addon1" value="<?php echo $product['description']; ?>"
                required>
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Purchase Price" name="purchase_price"
                ...
                value="<?php echo $product['purchase_price']; ?>" required>
        </div>
        <!-- Product price_offer -->
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Price Offer" name="price_offer"
                aria-label="Price Offer" aria-describedby="basic-addon1" value="<?php echo $product['price_offer']; ?>"
                required>
        </div>
        <!-- Product final_price -->
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Final Price" name="final_price"
                aria-label="Final Price" aria-describedby="basic-addon1" value="<?php echo $product['final_price']; ?>"
                required>
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Min Quantity" name="min_quantity"
                ...
                value="<?php echo $product['min_quantity']; ?>" required>
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Barcode" name="barcode" aria-label="Barcode"
                aria-describedby="basic-addon1" value="<?php echo $product['barcode']; ?>" required>
        </div>
