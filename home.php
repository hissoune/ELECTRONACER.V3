...
<body>
        ...
        <div class="container">
            ...
            <div id="navmenu" class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a href="#" class="nav-link hovri">Home</a>
                    </li>
                    <li class="nav-item">
                        <a href="" class="nav-link hovri">Products</a>
                    </li>
                    <li class="nav-item">
                        <a href="" class="nav-link hovri">About</a>
                    </li>
                </ul>
                <a href="#" id="pCart" class="navbar-brand"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-garden-cart" width="40" height="40" viewBox="0 0 24 24" stroke-width="1" stroke="red" fill="none" stroke-linecap="round" stroke-linejoin="round">
    ...
    <section class="lwl">
        <div class="pt-5 container d-flex gap-5">
            ...
            <div id="hah" class="pt-5 "><br>
                ...
                <h1>ElectroNacer</h1>
                <p>Welcome to Electronacer, your destination for cutting-edge electronics! Discover a curated selection of top-tier gadgets and accessories that redefine innovation. Elevate your lifestyle with premium electronic essentials.</p>
                <div >
    ...
    <section class="ts">
        <div class="text-center text-light pt-5">
            ...
            <p class="opacity-50 w-75 mx-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque officiis numquam, ipsam explicabo tenetur dolorem temporibus impedit esse iure corporis asperiores quia. Numquam dolore quidem maiores aperiam perspiciatis quos et.</p>
        </div>
        <div class="box pt-3">
            <div class="">
                <div class="row gap-3 justify-content-center text-center">
                    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12 bg-light b1">
                        ...
                        <div class="text">
                            <p>Discover the latest in mobile technology with our extensive range of smartphones. From cutting-edge features to sleek designs, find the perfect device to keep you connected and in style.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12 bg-white b1">
                        ...
                        <div class="text">
                            <p>Boost your productivity with our collection of powerful laptops. Whether you're a professional, a student, or a casual user, we have the right laptop to meet your requirements. Explore now and redefine your computing experience.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12 bg-light b1">
                        <div class="title py-3">
                        ...
                        <div class="text">
                            <p>Unleash your creativity with our range of digital cameras and accessories. Whether you're a photography enthusiast or a beginner, we have the perfect tools to help you capture and cherish every moment.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12 bg-white b1">
                        <div class="title py-3">
                        ...
                        <div class="text">
                            <p>Step into the world of gaming with our extensive collection of gaming consoles, accessories, and peripherals. Elevate your gaming experience with cutting-edge technology</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12 bg-light b1">
                        <div class="title py-3">
                        ...
                        <div class="text">
                            <p>Boost your productivity with our collection of powerful laptops. Whether you're a professional, a student, or a casual user, we have the right laptop to meet your requirements</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12 bg-white b1">
                        <div class="title py-3">
                        ...
                        <div class="text">
                            <p>Make your home smarter and more efficient with our range of smart home devices. From smart thermostats to security cameras</p>
                        </div>
                    </div>
                </div>
            </div>
